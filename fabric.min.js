...
"undefined" != typeof exports && (exports.fabric = fabric), "undefined" != typeof document && "undefined" != typeof window ? (fabric.document = document, fabric.window = window, window.fabric = fabric) : (fabric.document = require("jsdom").jsdom("<!DOCTYPE html><html><head></head><body></body></html>"), fabric.document.createWindow ? fabric.window = fabric.document.createWindow() : fabric.window = fabric.document.parentWindow), fabric.isTouchSupported = "ontouchstart" in fabric.document.documentElement, fabric.isLikelyNode = "undefined" != typeof Buffer && "undefined" == typeof window, fabric.SHARED_ATTRIBUTES = ["display", "transform", "fill", "fill-opacity", "fill-rule", "opacity", "stroke", "stroke-dasharray", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke-width", "id"], fabric.DPI = 96, fabric.reNum = "(?:[-+]?(?:\\d+|\\d*\\.\\d+)(?:e[-+]?\\d+)?)", fabric.fontPaths = {}, fabric.charWidthsCache = {}, fabric.devicePixelRatio = fabric.window.devicePixelRatio || fabric.window.webkitDevicePixelRatio || fabric.window.mozDevicePixelRatio || 1,
    ...
    function () {
        function t(t, r, s, o, h, c, l) {
            ...
            0 === c && L > 0 ? L -= 2 * f : 1 === c && L < 0 && (L += 2 * f);
            for (var D = Math.ceil(Math.abs(L / f * 2)), E = [], I = L / D, R = 8 / 3 * Math.sin(I / 4) * Math.sin(I / 4) / Math.sin(I / 2), F = P + I, B = 0; B < D; B++) E[B] = e(P, F, p, g, s, o, A, M, R, v, b), v = E[B][4], b = E[B][5], P = F, F += I;
            return n[u] = E, E
        }
                ...
                for (var r, n = t.getElementsByTagName("style"), s = {}, o = 0, a = n.length; o < a; o++) {
                    ...
                    h = h.replace(/\/\*[\s\S]*?\*\//g, ""), "" !== h.trim() && (r = h.match(/[^{]*\{[\s\S]*?\}/g), r = r.map(function (t) {
                        ...
                        t = r[1], t.split(",").forEach(function (t) {
                            t = t.replace(/^svg/i, "").trim(), "" !== t && (s[t] = v.util.object.clone(n))
                        })
                    }))
                }
                return s
    ...
    function (t) {
        ...
        return i.Intersection ? void i.warn("fabric.Intersection is already defined") : (i.Intersection = e, i.Intersection.prototype = {
            ...
            for (var n = new e, s = r.length, o = 0; o < s; o++) {
                var a = r[o],
                    h = r[(o + 1) % s],
    ...
    function () {
        ...
        fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, {
            ...
            _drawObjectsControls: function (t) {
                for (var e = 0, i = this._objects.length; e < i; ++e) this._objects[e] && this._objects[e].active && (this._objects[e]._renderControls(t), this.lastRenderedWithControls = this._objects[e])
            },
            _onObjectRemoved: function (t) {
                    ...
                    for (T.x = (t + .5) * y, k.x = r(T.x), h = 0; h < l; h++) {
                        for (T.y = (h + .5) * _, k.y = r(T.y), g = 0, j = 0, A = 0, M = 0, P = 0, c = k.x - C; c <= k.x + C; c++)
                            if (!(c < 0 || c >= e)) {
                                ...
                                for (var E = k.y - w; E <= k.y + w; E++) E < 0 || E >= o || (D = r(1e3 * s(E - T.y)), O[L][D] || (O[L][D] = m(n(i(L * x, 2) + i(D * S, 2)) / 1e3)), u = O[L][D], u > 0 && (d = 4 * (E * e + c), g += u, j += u * v[d], A += u * v[d + 1], M += u * v[d + 2], P += u * v[d + 3]))
                ...
                for (var h = this.rcpScaleX, l = this.rcpScaleY, u = c(h / 2), f = c(l / 2), d = t.getContext("2d"), g = d.getImageData(0, 0, e, i), p = g.data, v = d.getImageData(0, 0, o, a), b = v.data, m = 0; m < a; m++)
                    for (var y = 0; y < o; y++) {
                        for (var _ = 4 * (y + m * o), x = 0, S = 0, C = 0, w = 0, O = 0, T = 0, k = 0, j = (m + .5) * l, A = r(m * l); A < (m + 1) * l; A++)
                            for (var M = s(j - (A + .5)) / f, P = (y + .5) * h, L = M * M, D = r(y * h); D < (y + 1) * h; D++) {
                                var E = s(P - (D + .5)) / u,
                                    I = n(L + E * E);
                                I > 1 && I < -1 || (x = 2 * I * I * I - 3 * I * I + 1, x > 0 && (E = 4 * (D + A * e), k += x * p[E + 3], C += x, p[E + 3] < 255 && (x = x * p[E + 3] / 250), w += x * p[E], O += x * p[E + 1], T += x * p[E + 2], S += x))
                            }
    ...
    function (t) {
        ...
        a.push("fontFamily", "fontWeight", "fontSize", "text", "textDecoration", "textAlign", "fontStyle", "lineHeight", "textBackgroundColor"), e.Text = e.util.createClass(e.Object, {
            ...
            _renderTextLine: function (t, e, i, r, n, s) {
                ...
                for (var a, h = i.split(/\s+/), c = 0, l = this._getWidthOfWords(e, i, s, 0), u = this.width - l, f = h.length - 1, d = f > 0 ? u / f : 0, g = 0, p = 0, v = h.length; p < v; p++) {
                    for (;
                        " " === i[c] && c < i.length;) c++;
            ...
            _renderTextFill: function (t) {
                if (this.fill || !this.isEmptyStyles())
                    for (var e = 0, i = 0, r = this._textLines.length; i < r; i++) {
            ...
            _renderTextStroke: function (t) {
                if (this.stroke && 0 !== this.strokeWidth || !this.isEmptyStyles()) {
                    var e = 0;
                    this.shadow && !this.shadow.affectStroke && this._removeShadow(t), t.save(), this.strokeDashArray && (1 & this.strokeDashArray.length && this.strokeDashArray.push.apply(this.strokeDashArray, this.strokeDashArray), s && t.setLineDash(this.strokeDashArray)),
                        t.beginPath();
            ...
            _setSVGTextLineJustifed: function (t, i, r, s) {
                ...
                for (s += this._getLineLeftOffset(this._getLineWidth(a, t)), t = 0, c = u.length; t < c; t++) h = u[t], i.push('\t\t\t<tspan x="', n(s, o), '" ', 'y="', n(r, o), '" ', v, ">", e.util.string.escapeXml(h), "</tspan>\n"), s += this._getWidthOfWords(a, h) + p
            },
        ...
        fabric.IText = fabric.util.createClass(fabric.Text, fabric.Observable, {
            ...
            renderSelection: function (t, e, i) {
                ...
                for (var r = this.get2DCursorLocation(this.selectionStart), n = this.get2DCursorLocation(this.selectionEnd), s = r.lineIndex, o = n.lineIndex, a = s; a <= o; a++) {
                    ...
                    l = c, (this.lineHeight < 1 || a === o && this.lineHeight > 1) && (c /= this.lineHeight), i.fillRect(e.left + h, e.top + e.topOffset, u, c), e.topOffset += l
                }
            },
            _renderChars: function (t, e, i, r, n, s, o) {
                ...
                for (var f = o, d = i.length + o; f <= d; f++) a = a || this.getCurrentCharStyle(s, f), h = this.getCurrentCharStyle(s, f + 1), (this._hasStyleChanged(a, h) || f === d) && (this._renderChar(t, e, s, f - 1, u, r, n, c), u = "", a = h), u += i[f - o];
                e.restore()
            },
